...
hylim <- c(0, 51, 64, 81)
pslim <- c(0, 44, 60, 81)
safnlim <- rev(c(0.66, 0.32, 0.16, 0))
aqhablim <- c(0, 0.16, 0.32, 0.66)
subnatlim <- c(0, 0.16, 0.32, 0.66)
flowhablim <- c(0, 0.16, 0.32, 0.66)
veglim <- c(0, 0.16, 0.32, 0.66)
...
output$pchemhab <- renderGauge({
    ...
    gauge(val, min = 0, max = 100, symbol = '%', gaugeSectors(
     success = c(0, 49), warning = c(49, 98), danger = c(98, 100),
...
output$pchem <- renderGauge({
  ...
  gauge(val, min = 0, max = 100, symbol = '%', gaugeSectors(
     success = c(0, 44), warning = c(44, 87), danger = c(87, 100),
     colors = allcol[c(1, 5, 4)]
  ))
...
output$phab <- renderGauge({
  ...
  gauge(val, min = 0, max = 100, symbol = '%', gaugeSectors(
     success = c(0, 36), warning = c(36, 72), danger = c(72, 100),
     colors = allcol[c(1, 5, 4)]
  )
  )
...
```{r}
renderText({paste0('Total score: ', round(cats()$indexscore_cram, 1))})
column(width = 12,
...
```{r}
renderText({paste0('Total score: ', round(cats()$IPI, 1))})
column(width = 12,
