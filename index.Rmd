...
The overall SQI score for a site (far right on the above figure) is based on the categorical combinations of stressor (unstressed, stressed) and biological (healthy, impacted) conditions.  Based on these combinations, a site is assigned one of four scores shown below.  
